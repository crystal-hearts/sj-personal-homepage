    ...
    <Main>
      <Section>
        ...
        >
          <p>
            <span>
              For this site, I wanted to evoke the spirit of late-1990s spirit
              of personal homepages by building an{" "}
              <strong>
                intentionally retro-styled site using contemporary tools and
                frameworks
              </strong>
              . I have a lot of love for the do-it-yourself ethos that drove a
              lot of the early Internet and wanted to capture that feeling in a
              way that also communicates something about who I am and what I
              care about.
            </span>
          </p>
          <p>
            <span>
              ...
              serious Web applications have an element of fun if they&lsquo;re
              built well.
            </span>
          </p>
          <p>
          ...
          <p>
            <span>
              ...
              , and the groovy 90s-does-60s psychedelia of EarthBound and the
              Sega Dreamcast.
            </span>
          </p>
          <p>
